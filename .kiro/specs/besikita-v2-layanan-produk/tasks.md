...
- [ ] 4. Navigasi dan penyempurnaan
  - [x] 4.1 Verifikasi semua tombol "Lihat Detail" di `/services` mengarah ke halaman detail yang benar. Pastikan `href` di setiap `ProductCard` sesuai dengan `id` produk yang dirender.
    - _Requirements: 2.6_
